print('This script is just for reference, you should check another branch for the actual code.')
...
#     from basic_map import map_geometric
#     from pkg_path_plan.path_plan_graph import dijkstra
...
#     the_planner = dijkstra.DijkstraPathPlanner(scene_graph.NG)
