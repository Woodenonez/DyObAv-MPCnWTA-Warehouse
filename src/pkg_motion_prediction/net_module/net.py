...
from pkg_motion_prediction.net_module.submodules import compact_conv_layer as conv
from pkg_motion_prediction.net_module.module_wta import *

from pkg_motion_prediction.net_module import module_mdn
