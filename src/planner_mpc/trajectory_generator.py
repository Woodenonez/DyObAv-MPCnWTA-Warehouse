...
from planner_mpc.mpc.mpc_generator import MpcModule
from planner_mpc.util.config import Configurator
from planner_mpc.obstacle_scanner.dynamic_obstacle_scanner import ObstacleScanner
...
class TrajectoryGenerator:
    ...
    def __init__(self, config:Configurator, build:bool=False, use_tcp:bool=False, verbose=False):
        ...
        self.set_obstacle_weights(stc_weights=1e3, dyn_weights=1e2) # default obstacle weights
