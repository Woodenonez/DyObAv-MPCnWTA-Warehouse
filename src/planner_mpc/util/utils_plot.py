...
def prepare_plot(fig, graph, start=None, end=None, legend_style='single', double_map=False, color_list=None, legend_list=None):
    ...
    if legend_style == 'single':
        legend_elems = [Line2D([0], [0], linewidth=0, marker='s', color='k', label='Static Obstacles'),
                        Line2D([0], [0], linewidth=0, marker='o', color='r', label='Dynamic Obstacles'),
                        Line2D([0], [0], linewidth=0, marker='o', color='y', label='Padded Dynamic Obstacles'),
